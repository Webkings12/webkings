...
<!--  회원정보 수정 -->
	<div id="divEdit" class="modal">
			<div class="amodel">
			<span onclick="document.getElementById('divEdit').style.display='none'" class="close" title="Close Modal">&times;</span>
				<form id="formEdit" name="formEdit" target="_iFrmForAction"
					...
					<div id="divedit">
						<label for="mNick">닉네임: </label> <input type="text" name="mNick"
							placeholder="닉네임" id="mNick" value="${membervo.mNick}"><br>
						<input type="text" name="oldmpwd" placeholder="예전비밀번호"
							id="oldmpwd"><br> <input type="hidden"
							name="chkpwd" id="chkpwd" value="${membervo.mPwd}"><br>
