...
public class QnaReplyViewVO {
	...
	public String toString() {
		return "QnaReplyViewVO [qrNo=" + qrNo + ", qrNoGroup=" + qrNoGroup + ", qrGbn=" + qrGbn + ", qrContent="
				+ qrContent + ", qrRegdate=" + qrRegdate + ", qrChgdate=" + qrChgdate + ", qNo=" + qNo + ", mNo=" + mNo
				+ ", mEmail=" + mEmail + ", mImage=" + mImage + ", mNick=" + mNick + "]";
	}
